  ...
  reasoningLog: [
    {
      ...
      investigator: {
        ...
        support: 78,
        contra: 0,
        text: 'KBDI and FWI both climbed sharply over the 5 days before detection, consistent with drought-driven ignition risk independent of land use.',
      },
      skeptic: {
        hypothesis: 'H3',
        support: 35,
        contra: 0,
        text: 'A mapped production-zone concession sits within 1.2km; plantation-related land clearing cannot be ruled out from weather data alone.',
      },
    },
    {
      round: 2,
      ...
      investigator: {
        ...
        support: 82,
        contra: 18,
        text: 'No vegetation-change signal (E5) is strong enough to distinguish deliberate clearing from opportunistic burning under already-dry conditions. Rainfall dropped to near zero for 6 consecutive days (E2).',
      },
      skeptic: {
        hypothesis: 'H3',
        support: 29,
        contra: 44,
        text: 'Conceded: concession overlap alone is not causal evidence (E6 is contextual, not mechanistic). Weather case for H1 is well-supported.',
      },
    },
    {
      round: 3,
      ...
      investigator: {
        ...
        support: 82,
        contra: 18,
        text: 'Final: environmental conditions are the best-supported explanation. Recommend standard-priority review rather than urgent escalation.',
      },
      skeptic: {
        hypothesis: 'H3',
        support: 29,
        contra: 46,
        text: 'Final: agrees H1 is best-supported. H3 remains open only because concession proximity is unresolved, not because of positive evidence.',
      },
    },
  ],
  evidence: {
  ...
  reasoningLog: [
    {
      ...
      investigator: {
        ...
        support: 70,
        contra: 0,
        text: 'The 2026-09-07 detection sits inside the same KHG dome as the original ignition, with no intervening re-vegetation signal in the SAR record between the two surface detections.',
      },
      skeptic: {
        hypothesis: 'FC2',
        support: 40,
        contra: 0,
        text: 'Two kilometers is not close; this could equally be a fresh ignition sharing the same regional drought conditions rather than the same fire.',
      },
    },
    {
      round: 2,
      ...
      investigator: {
        ...
        support: 76,
        contra: 24,
        text: 'The Richards-ellipse projection from the first detection, driven by observed wind, plausibly reaches the second detection location by day 9-10 (E9). Combined with persistent VH drop (E4), this is more than coincidental timing.',
      },
      skeptic: {
        hypothesis: 'FC2',
        support: 34,
        contra: 38,
        text: 'Wind direction over the period (E2) is not strongly aligned with the ellipse\'s major axis toward the second detection, which weakens the propagation-path reading somewhat.',
      },
    },
    {
      round: 3,
      ...
      investigator: {
        ...
        support: 78,
        contra: 22,
        text: 'Final: same-dome SAR persistence plus geometric plausibility is the strongest available explanation. Recommend urgent field verification given protected-dome status.',
      },
      skeptic: {
        hypothesis: 'FC2',
        support: 34,
        contra: 44,
        text: 'Final: does not contest that FC1 is best-supported, but wind-direction evidence (E2) keeps independent ignition from being ruled out. Recommend the report present this as unresolved, not confirmed underground tracking.',
      },
    },
  ],
  evidence: {
